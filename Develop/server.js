//--------------files required so that everything works
const fs = require('fs');
...
//----------------------------------------------------------- Functions
/**
 * This function adds the notes to the left-hand side of the screen
 * @param {*} arrNotes The parameter ID for the notes
 * @param {*} oNote The variable for the note
 * @returns the note
 */
 ...
 * @param {*} arrNotes the array of notes
 * @param {*} idDelete the ID to delete
 */
